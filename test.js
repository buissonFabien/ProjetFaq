//init section
function inject(src, type,callback) { // fonction qui permet d'injecter un css ou un javascript dynamiquement dans la page
    type = type || 'js';
    if (type == 'js') {
...
inject("https://ajax.googleapis.com/ajax/libs/angularjs/1.2.21/angular.min.js", "js",angularjs);


function angularjs(){
	var divx = document.getElementById('wscdiv');
	divx.innerHTML = '%S2';
	//************************************//
	//**************Module****************//
	//************************************//
...
//************************************//
  $scope.tfidf = function(text){
	...
	var words_ru = ['?', '?????', '???', '?????', '?', '??????', '???', '???', '??', '????','??????', '???', '??', '???????', '?????', '???', '??', '??', '???', '????','???????', '???', '?????', '?????', '??????', '???', '??????', '?????', '????','??', '?????', '??', '?????', '???', '???', '????', '?', '???', '??','??????', '?????', '?', '????? ????', '?????', '?????', '??????','???', '???????', '??????', '??', '??', '??????', '???', '??????', '??????','??????', '????', '???', '?????', '??????', '???????', '?????', '?????', 'c','???????', '??? ???', '???', '?????', '???', '??', '???', '????', '???', '??','?????', '????', '???', '???', '?????', '???', '????', '??', '??????','???', '???', '???????', '????', '???', '? ???', '????? ??', '??', '????','?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?','o', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?', '?','?', '?', '?','$', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '_'];

	var stopWords = words_fr.concat(words_es).concat(words_it).concat(words_ne).concat(words_en).concat(words_ru);
